      ...
      <div className=" px-3 w-full mx-auto max-w-6xl">
        ...
        >
          <div className="flex flex-col md:flex-row relative justify-between py-10 px-[30px] md:px-[60px] gap-6 md:gap-0">
            ...
            <div className="broder-none md:border-l pl-0 md:pl-4">
              <h4 className="text-white mb-2.5 text-2xl md:text-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-y-10 gap-x-5 py-14">
          ...
          <div>
            <h5 className="text-white mb-5 font-semibold"> Important Link </h5>
            <ul className="flex flex-col">
              <li className="block pb-4">
                <a
          ...
          <div>
            <h5 className="text-white mb-5 font-semibold"> Terms </h5>
            <ul className="flex flex-col">
              <li className="block pb-4">
                <a
